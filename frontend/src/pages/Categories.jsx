...
// // import { Autoplay } from "swiper";; // Correct module path

// export default function Categories() {
//   const [visibleCategories, setVisibleCategories] = useState(4);
//   const[categories , setCategories] = useState([])
//   const [isPlaying, setIsPlaying] = useState(false); // State to track autoplay
...
//    const images = [
//     { src: "/indian thali.png", alt: "Slide 1" },
//     { src: "/indian_thali2.png", alt: "Slide 2" },
//     { src: "/indian_thali3.png", alt: "Slide 3" }, // Replace with your actual image URLs
//   ];
...
//   const handleToggle = () => {
//     setIsPlaying((prev) => !prev); // Toggle autoplay state
//   };
  ...
  return (
    <div className="bg-gray-100 mt-16 mb-14 min-h-screen p-8">
      ...
      <div className="relative bg-red-600 text-white rounded-3xl overflow-hidden shadow-lg">
        ...
        <div className="absolute top-4 right-4 flex flex-col space-y-2">
        <button
          className="p-2 bg-white rounded-full shadow-md text-red-600"
